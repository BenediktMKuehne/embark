...
# EMBA stuff
# EMBA hosts
EMBA_HOSTS = os.environ.get('EMBA_HOST_LIST')  # ['127.0.0.1']
# EMBA location
EMBA_ROOT = os.path.join(BASE_DIR.parent, 'emba')
EMBA_ROOT_TARGET = os.path.join(os.environ.get('EMBA_TARGET_LOCATION'), 'emba')
EMBA_LOG_TARGET = os.path.join(os.environ.get('EMBA_LOG_TARGET_LOCATION'), 'emba_logs')
